...
//	erase_flash_page(address);
	return 0 ;//write_flash(address, data, size);
#else
...
#else
	adc_value = 100; //ADC_DualConvertedValueTab[index];
#endif
...
#define get_IO_Status(io) 1
#define get_LED_Status(led) 1
