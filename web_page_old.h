...
#define index_page			"<html>"\
								"<head>"\
								"<title>Pico Pixel Controller</title>"\
								"<meta http-equiv='Content-Type' content='text/html; charset=utf-8'>"\
								"</head>"\
								"<body>"\
									"<div>"\
									"Pico Pixel Controller"\
									"</div>"\
									"<br>"\
...
#define netinfo_page 		"<!DOCTYPE html>"\
							"<html>"\
								"<head>"\
								"<title>Pico Pixel Controller Network Info</title>"\
								"<meta http-equiv='Content-Type' content='text/html; charset=utf-8'>"\
								"<style>"\
								...
								"<body onload='getNetinfo();'>"\
									"<div>"\
									"Pico Pixel Controller Network Information"\
									"</div>"\
									"<br>"\
									"<ul>"\
...
#define dio_page  			"<!DOCTYPE html>"\
							"<html>"\
								"<head>"\
								"<title>Pico Pixel Controller Digital I/O</title>"\
								"<meta http-equiv='Content-Type' content='text/html; charset=utf-8'>"\
								"<script type='text/javascript' src='ajax.js'></script>"\
...
#define ain_page  			"<!DOCTYPE html>"\
							"<html>"\
								"<head>"\
								"<title>Pico Pixel Controller Analog Input</title>"\
								"<meta http-equiv='Content-Type' content='text/html; charset=utf-8' />"\
...
#define ain_gauge_page		"<!DOCTYPE html>"\
							"<html>"\
								"<head>"\
								"<title>Pico Pixel Controller Analog Input Gauge</title>"\
								"<meta http-equiv='Content-Type' content='text/html; charset=utf-8' />"\
								"<meta http-equiv='pragma' content='no-cache' />"\
 	 	 	 	 	 	 	 	"<meta http-equiv='content-type' content='no-cache, no-store, must-revalidate' />"\
								"<script type='text/javascript' src='ajax.js'></script>"\
...
#define img_page			"<!DOCTYPE html>"\
							"<html>"\
								"<head>"\
								"<title>Pico Pixel Controller Image</title>"\
								"<meta http-equiv='Content-Type' content='text/html; charset=utf-8' />"\
								"<meta http-equiv='pragma' content='no-cache' />"\
								"<meta http-equiv='content-type' content='no-cache, no-store, must-revalidate' />"\
								"</head>"\
